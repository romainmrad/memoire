...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:RhoControlVisualisation1}
    \end{subfigure}
...
\FloatBarrier\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:BetaControlVisualisation1}
    \end{subfigure}
...
\FloatBarrier\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:KappaControlVisualisation1}
    \end{subfigure}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:RhoControlVisualisation2}
    \end{subfigure}
...
\FloatBarrier\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:BetaControlVisualisation2}
    \end{subfigure}
...
\FloatBarrier\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:KappaControlVisualisation2}
    \end{subfigure}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Contrôle Optimale $u^*(x)$}\label{fig:ControlVisualisation3}
    \end{subfigure}
    \caption{Visualisation de la fonction valeur et du contrôle optimale dans le cas d'un problème non linéarisable}\label{fig:ValueControlComparison3}
\end{figure}
\FloatBarrier\paragraph{Analyse}\phantom{}\\
...
Les paramètres utilisés sont ceux introduits lors de l'étude du temps moyen de sortie, avec et sans sauts, à la sous-partie (\ref{subsection_mean_jumps}). Les fonctions \( m(x) \) et \( m_0(x) \), données respectivement par (\ref{sol_mean_with_jumps}) et (\ref{sol_mean_with_0_jumps}), sont représentées graphiquement.
\paragraph{Visualisation}\phantom{}
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.5\linewidth]{img/validation/Jumps/mean_jumps.pdf}
...
Les paramètres considérés sont ceux définis dans l'étude de la probabilité de sortie en zéro, avec et sans sauts, présentée en sous-partie (\ref{subsection_probability_jumps}). Les fonctions \( p(x) \) et \( p_0(x) \), correspondant respectivement aux expressions (\ref{sol_probability_with_jumps}) et (\ref{sol_probability}), sont représentées graphiquement.
\paragraph{Visualisation}\phantom{}
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.5\linewidth]{img/validation/Jumps/probability_jumps.pdf}
...
Enfin, la variante à sauts exponentiels est considérée.
\paragraph{Visualisation}\phantom{}\\
