...
\paragraph{Caractérisation des Politiques Optimales}\phantom{}\\
En effectuant plusieurs simulations, il est possible de déduire les différentes stratégies optimales dans le cadre de chaque problème étudié:
\begin{itemize}
    ...
    \item \textbf{Stratégie P2 \textemdash~Attente et Frappe}\\
