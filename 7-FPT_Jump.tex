...
\subsection{Cas Particulier \textemdash~Sauts exponentiels ascendants}
...
Cette équation permet donc de résoudre le problème pour tout processus. Dans la suite, le \acs{CIR} est considéré.
