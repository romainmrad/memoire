...
\begin{itemize}
    ...
    \]
    Cela signifie que le processus peut atteindre zéro en un temps fini si $\sigma^2\geq2ab$. En d'autres termes, si la diffusion domine la dérive, le processus peut toucher le zéro.
\end{itemize}
\begin{figure}[htb]
    \centering
